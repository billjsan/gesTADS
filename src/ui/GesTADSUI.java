...
public abstract class GesTADSUI {
    ...
    protected String getUserInput() {
        if(GesLogger.ISFULLLOGABLE || GesLogger.ISSAFELOGGABLE)
            GesLogger.d(TAG, "get User Input");
    ...
    protected void showMessageDialog(String message){
        if(GesLogger.ISFULLLOGABLE || GesLogger.ISSAFELOGGABLE)
            GesLogger.d(TAG, "show Menssage Dialog");
    ...
    protected Integer getIntFromTheUser(){
        if(GesLogger.ISFULLLOGABLE || GesLogger.ISSAFELOGGABLE)
            GesLogger.d(TAG, "get Int From the user");
...
//                    "can't cast to int");
    ...
    protected Integer screenGetIntegerFromUser(){
        if(GesLogger.ISFULLLOGABLE || GesLogger.ISSAFELOGGABLE)
            GesLogger.d(TAG, "screen Get Interge From User");
